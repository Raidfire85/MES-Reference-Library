...
import { EXAMPLE_SYNC_END, EXAMPLE_SYNC_START } from './constants';
import { REQUIRED_PROFILE_TAGS } from '../sbc/profileHeaders';
import { findProfileFile } from './tagMetaParser';
import type { TagMetaMap } from './tagMetaParser';
...
export function buildProfileExampleSection(options: {
  ...
  return `${EXAMPLE_SYNC_START}
<div class="mes-profile-example">
<p>Here is an example of how a ${options.title} profile definition is set up:</p>
